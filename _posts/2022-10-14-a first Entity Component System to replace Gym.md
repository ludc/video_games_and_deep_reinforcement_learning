...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_fig2.png)
...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_fig3.png)
...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_component.png)
*The Component class*
...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_position.png)
*The Position Component*

![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_action.png)
*The Action Component*

and can be created like this:

![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_component_creation.png)
*Creating Components*

Similarly, it is possible to create an Entity class as:
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_entity.png)
*The Entity class*

and to define new entities types (also called Archetypes in some other ECS libraries):

![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_agent.png)
*The Agent Entity*

We can then create the entity describing an agent as:

![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_agent_creation.png)
...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_world.png)
...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_system.png)
...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_game.png)
*The Game class*
...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_game1.png)
...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_game2.png)
*The move agent system*

![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_game3.png)
*A random player*
...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_game4.png)
...
![](https://github.com/ludc/video_games_and_deep_reinforcement_learning/docs/assets/post1_game5.png)
